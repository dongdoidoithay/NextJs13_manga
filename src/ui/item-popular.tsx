export const ItemPopular = ({ text }: { text: string }) => {
  return (
    ...
    <div className="overflow-hidden relative mx-auto bg-white shadow-lg ring-1 ring-black/5 rounded-xl flex items-center gap-6 dark:bg-slate-800 dark:highlight-white/5">
      ...
      <div className="flex flex-col py-5 pl-24 ">
        <strong className="text-sm text-sky-300">Tensei Shitara Slime </strong>
