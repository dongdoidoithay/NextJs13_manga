export const ItemSlide = ({ text }: { text: string }) => {
  return (
    <div className="box-content h-56 w-44 border-2 mx-2 bg-slate-800 rounded-lg">
        <div className="flex flex-col space-y-0 text-sm">
            ...
            <h2 className="px-1 py-2 truncate ...  first-letter:text-red-300 first-letter:font-bold text-sky-300"> Manga {text}</h2>
