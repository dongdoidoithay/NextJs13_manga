...
export function GlobalNav() {
  ...
  return (
    <>
    {/* backdrop-blur  */}
      <div className="sticky lg:pl-72 top-0 z-40 w-full  flex-none transition-colors duration-500 lg:z-50 lg:border-b lg:border-slate-900/10 dark:border-slate-50/[0.06] supports-backdrop-blur:bg-white/95 dark:bg-slate-900/75">
        <div className="max-w-8xl mx-auto">
            <div className="relative flex items-center">
              <div className="text-xs  rounded-full py-1  hover:bg-sky-400/20 max-w-screen-lg">
              ...
              <div className="relative hidden lg:flex items-center ml-auto">
                ...
                <div className="flex items-center border-l border-slate-200 ml-6 pl-6 dark:border-slate-800">
                  ...
                  >
                    <span className="sr-only">Tailwind CSS on GitHub</span>icon
                  </a>
                </div>
              </div>
